 ...
 */
public class RustCodeEditor extends StackPane {
    ...
    private final String editingTemplate =
            "<!doctype html>" +
                    ...
                    "  <script src=\"http://codemirror.net/mode/rust/rust.js\"></script>" +
                    "</head>" +
                    "<body>" +
    ...
    public void setCode(String rustCode) {
        this.editingCode = rustCode;
        webview.getEngine().loadContent(applyEditingTemplate());
    }
}